                ...
                <div className="max-w-6xl mx-auto">
                    <div className="mb-8 sm:mb-10">
                        ...
                        <p className="text-sm sm:text-base md:text-lg font-inter text-gray-600 max-w-3xl leading-relaxed">
                            MockOraa required AI systems thinking beyond UI. I mapped the full data flow to ensure real-time latency was minimized and the intelligence layer served the user, not the other way around.
                        </p>
                    </div>
