                ...
                <div className="max-w-6xl mx-auto">
                    <div className="mb-12 sm:mb-16 text-center">
                        ...
                        <p className="text-base sm:text-lg font-inter text-gray-600 max-w-3xl mx-auto leading-relaxed">
                            The final prototype successfully bridged the gap between human anxiety and structured learning, proving that confidence can be designed for.
                        </p>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-lg border border-gray-200 max-w-2xl mx-auto">
                        <h3 className="text-xl font-grotesk font-bold text-black mb-6">What I&apos;d design next</h3>
