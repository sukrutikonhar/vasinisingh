                ...
                <div className="max-w-7xl mx-auto" ref={containerRef}>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
                        ...
                        <div className="lg:sticky lg:top-32 lg:h-fit">
                            <div className="inline-block bg-gray-100 rounded-full px-4 py-2 mb-4 sm:mb-6">
                            ...
                            {/* Highlight Box */}
                            <div className="bg-[#202022] text-white p-5 sm:p-6 md:p-8 rounded-[6px] shadow-card">
                        ...
                        <div className="space-y-4 sm:space-y-6">
                            {responsibilities.map((resp, index) => (
                                <div
                                    ...
                                    className={`bg-white rounded-[6px] shadow-card p-5 sm:p-6 md:p-8 transition-all duration-500 ${activeIndex === index
                                        ? 'border-2 border-gray-800 scale-[1.02]'
                                        : 'border border-gray-200 opacity-60'
                                        }`}
                                >
                                    <div className="flex items-start gap-3 sm:gap-4">
                                        <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-[#202022] flex items-center justify-center flex-shrink-0">
                                            {React.createElement(resp.icon, {
                                                className: "w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white"
                                            })}
                                        </div>
                                        <div className="flex-1 min-w-0">
                                            <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-grotesk font-bold text-[#202022] mb-2 sm:mb-3">
                                                {resp.title}
                                            </h3>
                                            <p className="text-xs sm:text-sm md:text-base font-inter text-gray-600 leading-relaxed">
                                                {resp.description}
                                            </p>
                                        </div>
                                    </div>
