            ...
            <div className="container-custom">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
                        ...
                        <div className="border-2 border-black p-8">
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <h3 className="text-2xl font-grotesk font-bold text-black">
                                    Email Me
                                </h3>
                            </div>
                            <a
                                href="mailto:hello@vasinisingh.com"
                                className="text-lg font-inter text-gray-700 hover:text-black transition-colors"
                            >
                    ...
                    <div className="text-center">
                        <h3 className="text-sm font-grotesk uppercase tracking-wider text-gray-500 mb-6">
                            Connect With Me
                        </h3>
                        <div className="flex items-center justify-center gap-4">
                            {socialLinks.map((social, index) => (
                                <a
                                    ...
                                    className="w-14 h-14 border-2 border-black flex items-center justify-center hover:bg-black hover:text-white transition-all group"
