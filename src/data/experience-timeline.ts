  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        type: "End-to-end UX",
        description: "Designed a fintech application end-to-end, covering information architecture, user flows, and high-fidelity UI for financial workflows.",
        chips: ["Fintech", "Information architecture", "User flows", "High-fidelity UI", "Financial workflows"],
      },
      {
        id: "graphics-newsletters",
        name: "Graphics & Newsletters",
        type: "Brand and marketing collateral",
        description: "Created brand and marketing collateral including graphics and newsletters for diverse client engagements across verticals.",
        chips: ["Graphic design", "Newsletter design", "Brand collateral", "Marketing materials"],
      },
    ],
  },
];
