...
export const experienceCompanies: ExperienceCompany[] = [
  ...
  },
  {
    ...
    accent: "#D85A30",
    summary: "Designed 40+ web and mobile products across healthcare, manufacturing, and enterprise, delivering end-to-end UX from research to high-fidelity UI, improving user engagement by up to 25% and reducing errors by ~20%.",
    projects: [
      {
        id: "healthcare",
        name: "Healthcare platforms",
        type: "Web & mobile products",
        description: "Designed internal and client-facing platforms for healthcare workflows, translating complex clinical processes into intuitive dashboards and reducing support queries through clear interaction design.",
      ...
      },
      {
        ...
        description: "End-to-end UX for manufacturing and industrial enterprise tools, streamlining operator workflows, reducing user errors, and improving feature adoption through usability testing and iterative design.",
