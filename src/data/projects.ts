...
export const completedProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    description: "Engineers across ABB's global teams were re-solving the same technical problems in isolation, with no shared memory of what had already been figured out. AKS turned scattered, one-off answers into a governed, searchable knowledge system.",
    ...
    statusBadge: "Testing Phase - Live MVP",
  },
  {
    id: 5,
    slug: "neuroassist",
...
export const selectedWorkProjects = completedProjects.filter((p) => ["arreglio", "ecoprism", "mockoraa"].includes(p.slug));
